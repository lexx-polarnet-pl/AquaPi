...
{/if}
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                <div class="row">
                    <div class="col-lg-6">
						<form action="co2.php?op=probe" method="post" class="form-horizontal">
							<section class="card">
                                <div class="card-header">
                                    <strong class="card-title" v-if="headerText">Ustawienia sondy pH</strong>
								</div>
								...
								<div class="card-body card-block">
									...
									<div class="row form-group">
										<div class="col-6"><label for="PRACT" class=" form-control-label">Odczyt bezpośredni</label></div>
										<div class="col-4"><input type="text" id="PRACT" name="PRACT" class="form-control" value="Brak danych" readonly></div>
										<div class="col-2"><label for="PRACT" class=" form-control-label">mV</label></div>										
									</div>		
									<div class="row form-group">
										<div class="col-6"><label for="PHACT" class=" form-control-label">Odczyt przeliczony</label></div>
										<div class="col-4"><input type="text" id="PHACT" name="PHACT" class="form-control" value="Brak danych" readonly></div>
										<div class="col-2"><label for="PHACT" class=" form-control-label">pH</label></div>
									</div>	
									<div class="row form-group">
										<div class="col-12"><label for="PHACT" class=" form-control-label">Wyznaczenie punktów korekcji</label></div>
									</div>		
									<div class="row form-group">
										<div class="col-5 input-group">
											<input type="number" id="MV1" name="MV1" class="form-control" value="{$CONFIG.co2_mv1}" step=0.0001 required>
											<div class="input-group-addon" onclick="javascript:copyval1()"><i class="fa fa-toggle-down"></i></div>
										</div>
										<div class="col-2">	<label for="MV1" class="form-control-label">mV</label></div>										
										<div class="col-3"><input type="number" id="PH1" name="PH1" class="form-control" value="{$CONFIG.co2_ph1}" step=0.01 required></div>
										<div class="col-2"><label for="PH1" class=" form-control-label">pH</label></div>										
									</div>	
									<div class="row form-group">
										<div class="col-5 input-group">
											<input type="number" id="MV2" name="MV2" class="form-control" value="{$CONFIG.co2_mv2}" step=0.0001 required>
											<div class="input-group-addon" onclick="javascript:copyval2()"><i class="fa fa-toggle-down"></i></div>
										</div>
										<div class="col-2"><label for="MV2" class=" form-control-label">mV</label></div>
										<div class="col-3"><input type="number" id="PH2" name="PH2" class="form-control" value="{$CONFIG.co2_ph2}" step=0.01 required></div>
										<div class="col-2"><label for="PH2" class=" form-control-label">pH</label></div>										
									</div>										
								</div>								
