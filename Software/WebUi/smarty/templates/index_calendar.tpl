...
{foreach from=$events item="event"}
    <tr bgcolor="{cycle values="#cccccc,#dddddd"}">
		<td class="{if $event.days lt 1}red bold blink{elseif $event.days lt 3}red{elseif $event.days lt 5}red2{elseif $event.days lt 7}red3{/if}" style="width:1%">{$event.start_ts|date_format:"%e.%m.%y&nbsp;%H:%M"}</td>
