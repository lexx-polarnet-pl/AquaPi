...
function get_header_tags($path)
{
	...
	return array(
			...
			tag('script', attrs('type="text/javascript"'),
					"var imagePath='plugins/calendar/$path/images/'"),
			tag('script', attrs('type="text/javascript"',
					"src=\"plugins/calendar/$path/phpc.js\""), ''),
			tag("script", attrs('type="text/javascript"',
					"src=\"plugins/calendar/$path/jquery.ui.timepicker.js\""), ''),
			tag("script", attributes('type="text/javascript"',
					"src=\"plugins/calendar/$path/jquery.hoverIntent.minified.js\""), ''),
			tag("script", attrs('type="text/javascript"',
					"src=\"plugins/calendar/$path/jpicker-$jpicker_version$jq_min.js\""), ''),
			tag('link', attrs('rel="stylesheet"', 'type="text/css"',
					"href=\"plugins/calendar/$path/jPicker-$jpicker_version$jq_min.css\"")),
		  );
}
