...
define('SQL_HOST',     $CONFIG['database']['host']);
define('SQL_USER',     $CONFIG['database']['user']);
define('SQL_PASSWD',   $CONFIG['database']['password']);
define('SQL_DATABASE', $CONFIG['database']['database']);
define('SQL_PREFIX',   'calendar_');
